import {FieldKey, NoPointers, PointerRules, PointerTypes} from "box"
import {
    Arrays,
    asDefined,
    assert,
...
export class BoxForge<E extends PointerTypes> {
    ...
    #writeBoxVisitor(): void {
        ...
        file.addImportDeclarations([
            {moduleSpecifier: "box", namedImports: ["VertexVisitor"]},
...
const JET_STD_LIBRARY = "std" as const
const JET_BOX_LIBRARY = "box" as const
...
class ClassWriter<E extends PointerTypes> {
    ...
    #writeClass(): void {
        ...
        if (noEdgeConstrains) {
            this.#imports.add("box", "UnreferenceableType")
        }
